...
def main():
    ...
    basic_group.add_argument('-r', '--recon', '--enumerate', metavar='DOMAIN', help='Retrieves MX records and info related to authentication, email, Azure, Microsoft 365, etc. If --usernames are specified, this also enables username enumeration.')
    ...
    advanced_group.add_argument('--shuffle-users', action='store_true', help='Randomize rows in users list at each password try')
